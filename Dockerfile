...
RUN mkdir -p /usr/src/metamedia_geonode
...
COPY src /usr/src/metamedia_geonode/
WORKDIR /usr/src/metamedia_geonode
...
RUN chmod +x /usr/src/metamedia_geonode/tasks.py \
    && chmod +x /usr/src/metamedia_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/metamedia_geonode/entrypoint.sh
