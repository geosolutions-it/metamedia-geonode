...
try:
    from metamedia_geonode.local_settings import *
except ImportError:
    from metamedia_geonode.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf metamedia_geonode/development.db")
    sh("rm -rf metamedia_geonode/uploaded/*")
    _configure_data_dir()
